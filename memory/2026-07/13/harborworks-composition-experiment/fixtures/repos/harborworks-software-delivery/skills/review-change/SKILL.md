---
name: review-change
description: Use software-delivery knowledge for a shallow remediation task.
...
2. Invoke `node src/cli.mjs --skill review-change --knowledge knowledge_base/overview.md` from the repository root.
